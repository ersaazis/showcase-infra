...
resource "aws_route" "control_plane_to_production" {
  route_table_id         = data.terraform_remote_state.control_plane_vpc.outputs.route_table_id
...
resource "aws_route" "production_to_control_plane" {
