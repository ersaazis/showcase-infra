...
output "data_production_to_production_route_table_id" {
  value = aws_route.data_production_to_production.route_table_id
...
output "production_to_data_production_route_table_id" {
  value = aws_route.production_to_data_production.route_table_id
